    ...
    triggerPipeline: function(params) {
        ...
        try {
            ...
            var payload = {
                ...
                variables: {
                    MigrationStage: {
                        value: params.migrationStage || 'InitialCopy'
                    },
                    BusinessReason: {
                        value: params.businessReason || ''
                    },
                    SourcePath: {
                    ...
                    MigrationDate: {
                        value: params.migrationDate || ''
                    },
                    ValidationOwner: {
                        value: params.validationOwner || ''
                    },
                    BusinessUnit: {
                        value: params.businessUnit || ''
                    },
                    RITM: {
                        value: params.ritm || ''
                    },
            ...
            gs.info('Azure DevOps payload: ' + JSON.stringify(payload));
